...
public class SHA256 {
  ...
  /*
   * bytesToInts and intsToBytes creates an int array out of a byte array and vice
   * versa. It does not convert but instead creates an array which reads the same
   * bits differently.
   */
  ...
  /*
   * padInts copies data from an array to a bigger one, which basically means that
   * the function returns the array with a bunch of added zeros.
   */
  ...
  /*
   * pads the input, stores length of the original data at the end, also adds a
   * 0x80 byte, I do not know why.
   */
   ...
   * states are returned as the hash.
   */
