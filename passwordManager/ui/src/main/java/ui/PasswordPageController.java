...
public class PasswordPageController extends PasswordManagerController {
  ...
  public void initialize() {
    ...
    SVGPath crossSvfPath = new SVGPath();
    crossSvfPath.setContent(
    ...
    addProfileClosePane.setShape(crossSvfPath);
  ...
  private GridPane profileComponent(String username, String title, String password, String id) {
    ...
    BackgroundFill redBackgroundFill = new BackgroundFill(Color.valueOf(lightRed),
        new CornerRadii(10), new Insets(10));
    final Background redBackground = new Background(redBackgroundFill);
